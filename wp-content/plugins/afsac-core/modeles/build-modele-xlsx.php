...
function afsac_build_readme_sheet() {
	$lines = array(
		...
		array( '4. Version anglaise d’un cours : ajoutez une DEUXIÈME ligne avec LA MÊME « cle », en mettant « en » dans la colonne « langue_fiche ». Les deux fiches seront automatiquement liées comme traductions. Seules « fr » et « en » sont acceptées.', 10 ),
